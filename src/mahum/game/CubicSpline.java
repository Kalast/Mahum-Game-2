...
class CubicSpline extends Spline
{
  ...
  public static void main(String[] args){
      ...
      float y = 200;
      for(int i = 0; i < 50; i ++){
          System.out.println(new Vec2((float)Math.round(y+(height / 2 + height / 2*Math.cos(2*Math.PI/20*i))), (float)Math.round(y+(height / 2 + height / 2*Math.cos(2*Math.PI/20*(i+1))))));
      }
